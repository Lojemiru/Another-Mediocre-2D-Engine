...
{   
    ...
    public static void ScrewYou(this SpriteBatch spriteBatch)
    {
    ...
    public static void SwapBlendState(this SpriteBatch spriteBatch, BlendState blendState, SamplerState? samplerState = null)
    {
        ...
        Begin(spriteBatch, SpriteSortMode.Deferred, blendState, samplerState, DepthStencilState.Default, RasterizerState.CullCounterClockwise, null, spriteBatch == Renderer.GuiBatch ? Matrix.Identity : Camera.Transform);
    }
    ...
    public static void ResetState(this SpriteBatch spriteBatch)
    {
        ...
        Begin(spriteBatch, SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, DepthStencilState.Default, RasterizerState.CullCounterClockwise, null, spriteBatch == Renderer.GuiBatch ? Matrix.Identity : Camera.Transform);
    }
    ...
    public static void SetShader(this SpriteBatch spriteBatch, Effect effect, BlendState? blendState = null, SamplerState? samplerState = null)
    {
        ...
        Begin(spriteBatch, SpriteSortMode.Deferred, blendState, samplerState, DepthStencilState.Default, RasterizerState.CullCounterClockwise, effect, spriteBatch == Renderer.GuiBatch ? Matrix.Identity : Camera.Transform);
    }
}